...
class MainWindow(wx.Frame):
	...
	def __init__(self, parent, id=wx.ID_ANY, title=None):
		...
		iglL5R.AddWithColourMask(wx.Bitmap(os.path.join(settings.install_dir, 'images/icosm_family_honor.png')), (255, 255, 255))
		iglL5R.AddWithColourMask(wx.Bitmap(os.path.join(settings.install_dir, 'images/icosm_hand.png')), (255, 255, 255))
		iglL5R.AddWithColourMask(wx.Bitmap(os.path.join(settings.install_dir, 'images/icosm_fate.png')), (255, 255, 255))
		iglL5R.AddWithColourMask(wx.Bitmap(os.path.join(settings.install_dir, 'images/icosm_favor.png')), (255, 255, 255))
		...
		if hasattr(sys, 'frozen'):
			try:
				...
				self.SetIcon(wx.Icon(os.path.join(settings.install_dir, 'images/icon.ico'), wx.BITMAP_TYPE_ICO))
		else:
			self.SetIcon(wx.Icon(os.path.join(settings.install_dir, 'images/icon.ico'), wx.BITMAP_TYPE_ICO))
	...
	def SetupToolbars(self):
		...
		toolbar.AddLabelTool(ID_MNU_HOST, 'Host table', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_host.png')),
			shortHelp='Host table', longHelp='Host a game table.')
		self.Bind(wx.EVT_TOOL, self.OnMenuHost, id=ID_MNU_HOST)
		
		toolbar.AddLabelTool(ID_MNU_CONNECT, 'Connect', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_connect.png')),
			shortHelp='Connect', longHelp='Connect to a host to play a game.')
		self.Bind(wx.EVT_TOOL, self.OnMenuConnect, id=ID_MNU_CONNECT)
		
		toolbar.AddLabelTool(ID_MNU_DISCONNECT, 'Disconnect', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_disconnect.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_JOIN_GAME, 'Join game', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_join_game.png')),
		...
		toolbar.AddLabelTool(ID_MNU_LEAVE_GAME, 'Leave game', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_leave_game.png')),
		...
		toolbar.AddLabelTool(ID_MNU_START_GAME, 'Start game', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_start.png')),
			shortHelp='Start game', longHelp='Start the game.')
		self.Bind(wx.EVT_TOOL, self.OnMenuStartGame, id=ID_MNU_START_GAME)
		
		# Game tools
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_STRAIGHTEN_ALL, 'Straighten all', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_straighten_all.png')),
		...
		toolbar.AddLabelTool(ID_MNU_REMOVE_MARKERS, 'Remove all markers', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_remove_markers.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_FAMILY_HONOR_SET, 'Set family honor', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_honor.png')),
		...
		toolbar.AddLabelTool(ID_MNU_FAMILY_HONOR_INC, 'Increase family honor', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_honor_add.png')),
		...
		toolbar.AddLabelTool(ID_MNU_FAMILY_HONOR_DEC, 'Decrease family honor', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_honor_sub.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_TAKE_FAVOR, 'Take Imperial Favor', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_favor.png')),
		...
		toolbar.AddLabelTool(ID_MNU_DISCARD_FAVOR, 'Discard Imperial Favor', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_favor_dis.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_FATE_DRAW, 'Draw Fate card', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_fate_draw.png')),
		...
		toolbar.AddLabelTool(ID_MNU_FATE_DRAW_X, 'Draw several Fate cards', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_fate_draw_x.png')),
		...
		toolbar.AddLabelTool(ID_MNU_HAND_REVEAL_X_RANDOM, 'Reveal random cards', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_fate_reveal_random.png')),
		...
		toolbar.AddLabelTool(ID_MNU_HAND_REVEAL, 'Reveal hand', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_fate_reveal.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_COIN_FLIP, 'Flip coin', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_flip_coin.png')),
		...
		toolbar.AddLabelTool(ID_MNU_ROLL_DICE, 'Roll die', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_roll_die.png')),
		...
		toolbar.AddSeparator()
		toolbar.AddLabelTool(ID_MNU_FOCUS_CREATE, 'Create focus pool', wx.Bitmap(os.path.join(settings.install_dir, 'images/tlb_icon_focuspool.png')),
